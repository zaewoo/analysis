...
- 학습 모델의 결과에서 **영화 개봉일자** 
- **영화 개봉일자**를 영화 개봉일자 기준 전체 관객 수의 **중앙값**, 혹은 **평균값**이 아닌 **라벨 인코딩**을 하였습니다. 그 이유는 **영화 개봉일자**가 영화의 관객 수를 예측하는 데에 중요한 특성이 아니기 때문입니다.
- 영화 개봉일자는 이전의 실행에서 영화 개봉일자를 치환해 보았을 때, 학습 모델의 성능 면에서 큰 차이를 확인할 수 없었습니다. 
