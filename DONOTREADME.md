...
### 상세
더 자세한 내용은 아래 별도의 링크에서 다루고 있습니다.
...
## 본문: 모델
이 프로젝트에서는 영화 관객 수 분류에 의해 영화의 관객 수를 예측해야 하므로 데이터 마이닝에서의 주요 분류 기법에 해당하는 의사결정나무, 다항 로짓 모형, 다층 퍼셉트론을 사용하겠습니다. 그리고 가장 성능이 좋은 기법을 최종안으로 채택하겠습니다.
