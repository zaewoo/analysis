...
이 프로젝트는 이 논문을 참고하였습니다. 그리고 이 본문 내용에 의해 다음의 세 가지 모델을 사용하여 예측하였습니다.

이 프로젝트는 이 데이터를 사용하였습니다. 그리고 그 데이터를 통해서 얻을 수 있는 결과는 예상되는 관객의 수에 대한 범주이므로 다음의 세 가지 모델을 사용하여 예측하였습니다.
